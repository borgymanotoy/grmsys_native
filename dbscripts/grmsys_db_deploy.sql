...
-- Script date 14/10/2015 11:47:35 PM
...
BEGIN
  ...
  SELECT COUNT(is1.item_sales_id) INTO nItemCount FROM item_sales_details is1 WHERE is1.item_id = pItemId;

  IF 0 = nItemCount THEN
    START TRANSACTION;
    DELETE FROM ITEM_SALES_DETAILS WHERE ITEM_ID = pItemId;
...
(1, 'Member', 'Anonymous', NULL, NULL, NULL, NULL, 'M', 'n/a', 'n/a', 'n/a', '2015-10-13 11:11:43', '2015-10-13 11:11:43', 1);
...
(14, 1, 'Daily', 0, 'weights', NULL, NULL, '2015-10-13 11:11:43', NULL, 1);
