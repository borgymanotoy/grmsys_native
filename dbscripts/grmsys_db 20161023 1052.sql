...
-- Script date 23/10/2016 10:52:17 AM
...
--
-- Definition for table role_type
--
...
--
-- Definition for view vw_administrators
--
DROP VIEW IF EXISTS vw_administrators CASCADE;
CREATE OR REPLACE 
	DEFINER = 'root'@'localhost'
VIEW vw_administrators
AS
...
VIEW vw_items
AS
	select `i`.`id` AS `item_id`,`i`.`name` AS `item_name`,`i`.`price` AS `item_price`,`i`.`quantity` AS `quantity`,`i`.`other_info` AS `item_infos`,`i`.`user_id` AS `user_id` from `item` `i`;
...
(75, 118, 2, 60, '', 1, '2016-10-22 08:11:07'),
(76, 118, 2, 60, '', 1, '2016-10-22 08:17:51'),
(77, 118, 2, 60, '', 1, '2016-10-22 08:19:02'),
(78, 118, 2, 60, '', 1, '2016-10-22 08:22:15'),
(79, 118, 2, 60, '', 1, '2016-10-22 08:36:31'),
(80, 118, 10, 300, '', 1, '2016-10-22 08:40:22'),
(81, 118, 2, 60, '', 1, '2016-10-22 08:41:51'),
(81, 118, 2, 60, '', 1, '2016-10-22 08:44:15'),
(81, 118, 1, 30, '', 1, '2016-10-22 08:44:39'),
(82, 118, 1, 30, '', 1, '2016-10-22 08:45:10'),
(83, 118, 2, 60, '', 1, '2016-10-22 08:56:15'),
(84, 118, 3, 90, '', 1, '2016-10-22 08:57:04'),
(85, 118, 2, 60, '', 1, '2016-10-22 08:58:24'),
(86, 118, 1, 30, '', 1, '2016-10-22 08:59:51'),
(87, 118, 1, 30, '', 1, '2016-10-22 09:00:59'),
(88, 118, 1, 30, '', 1, '2016-10-22 09:03:08'),
(89, 119, 3, 30, '', 1, '2016-11-25 09:49:06'),
(90, 119, 17, 170, '', 1, '2016-10-22 10:07:22'),
(91, 119, 16, 150, '', 1, '2016-10-22 10:09:35');

-- 
-- Dumping data for table role_type
--
INSERT INTO role_type VALUES
('Attendant', 'Attendant', '', 1, '2016-10-07 13:31:14', '2016-10-07 13:31:14'),
('Administrator', 'Administrator', '', 1, '2016-10-07 13:31:33', '2016-10-07 13:31:33');
...
(1, 'administrator', '21232f297a57a5a743894a0e4a801fc3', 'GrmSys', 'Administrator', 'Admin', '', '', '0000-00-00', 'M', '2016-10-18 23:50:24', 1, 1, 'Administrator', '2015-08-21 23:49:07', '2016-10-20 05:04:10', '', '', '', '', '', ''),
(1101, 'patrick', '21232f297a57a5a743894a0e4a801fc3', 'John', 'Agduma', 'Marcha', '(989) 899-8989', 'Buhangin', '0000-00-00', 'M', NULL, 0, 1, 'Attendant', '2016-10-22 08:08:01', '2016-10-22 08:08:01', 'q1', 'a1', 'q2', 'a2', 'q3', 'a3'),
(1102, 'ponso', '21232f297a57a5a743894a0e4a801fc3', 'alfonso', 'alfonso', 'A.', '(989) 889-8988', 'davao', '0000-00-00', 'M', '2016-10-22 09:26:05', 1, 1, 'Attendant', '2016-10-22 09:12:35', '2016-10-22 09:26:05', 'q1', 'a1', 'q2', 'a2', 'q3', 'a3');

-- 
-- Dumping data for table item
--
INSERT INTO item VALUES
(118, 'Vitamilk', 30.00, 14, '', 1, '2016-10-22 08:10:16', '2016-10-22 08:40:49'),
(119, 'Egg', 10.00, 20, '', 1, '2016-11-25 09:48:41', '2016-10-23 10:06:08');

-- 
-- Dumping data for table member
--
INSERT INTO member VALUES
(1025, 'Niko', 'Mateo', 'A.', '(989) 898-9889', 'Davao City', '1997-02-13', 'M', 'Sean', '(989) 898-9898', 'Friend', '2016-10-22 08:09:47', '2016-10-22 08:09:47', 1),
(1026, 'alfonso', 'alfonso', 'alfonso', '(989) 889-8994', 'davao', '1997-05-07', 'M', 'niko', '(989) 898-9998', 'friend', '2016-10-22 09:43:53', '2016-10-22 09:43:53', 1);

-- 
-- Dumping data for table item_sales
--
INSERT INTO item_sales VALUES
(75, 60.00, '2016-10-22 08:11:07', 1025, 1, '2016-10-22 08:11:07'),
(76, 60.00, '2016-10-22 08:17:51', 1025, 1, '2016-10-22 08:17:51'),
(77, 60.00, '2016-10-22 08:19:02', 1025, 1, '2016-10-22 08:19:02'),
(78, 60.00, '2016-10-22 08:22:15', 1025, 1, '2016-10-22 08:22:15'),
(79, 60.00, '2016-10-22 08:36:31', 1025, 1, '2016-10-22 08:36:31'),
(80, 300.00, '2016-10-22 08:40:22', 1025, 1, '2016-10-22 08:40:22'),
(81, 30.00, '2016-10-22 08:41:51', 1025, 1, '2016-10-22 08:41:51'),
(82, 30.00, '2016-10-22 08:45:09', 1025, 1, '2016-10-22 08:45:09'),
(83, 60.00, '2016-10-22 08:56:15', 1025, 1, '2016-10-22 08:56:15'),
(84, 90.00, '2016-10-22 08:57:04', 1025, 1, '2016-10-22 08:57:04'),
(85, 60.00, '2016-10-22 08:58:24', 1025, 1, '2016-10-22 08:58:24'),
(86, 30.00, '2016-10-22 08:59:51', 1025, 1, '2016-10-22 08:59:51'),
(87, 30.00, '2016-10-22 09:00:59', 1025, 1, '2016-10-22 09:00:59'),
(88, 30.00, '2016-10-22 09:03:08', 1025, 1, '2016-10-22 09:03:08'),
(89, 30.00, '2016-11-25 09:49:06', 1025, 1, '2016-11-25 09:49:06'),
(90, 170.00, '2016-10-22 10:07:22', NULL, 1, '2016-10-22 10:07:22'),
(91, 150.00, '2016-10-22 10:09:35', NULL, 1, '2016-10-22 10:09:35');

-- 
-- Dumping data for table membership_type
--
INSERT INTO membership_type VALUES
(22, 1025, 'Monthly', 0, 'weights', '2016-10-22', '2016-11-22', '2016-10-22 08:09:47', '2016-10-22 08:10:50', 1),
(23, 1026, 'Monthly', 0, 'weights', '2016-10-23', '2016-11-23', '2016-10-22 09:43:53', '2016-10-23 09:46:22', 1);

-- 
-- Dumping data for table workout_sales
--
INSERT INTO workout_sales VALUES
(26, 1025, '2016-10-22', 8, 'weights', 450.00, 'Paid', '', 1, '2016-10-22 08:10:50'),
(27, 1026, '2016-10-22', 9, 'weights', 45.00, 'Paid', '', 1, '2016-10-22 09:44:47'),
(28, 1026, '2016-10-23', 9, 'weights', 450.00, 'Paid', '', 1, '2016-10-23 09:46:22'),
(29, 1026, '2016-10-24', 9, 'weights', 0.00, 'Paid', '', 1, '2016-10-24 09:47:13');
